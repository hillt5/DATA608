...
ny_bc_fix$level_fct <- factor(ny_bc_fix$level_fct, ordered = TRUE, levels = c('Regional Center', 'Level 3', 'Level 2', 'Level 1')) #convert centers to factor
